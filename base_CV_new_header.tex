...
\email{gonzalo@grcanosa.com}                      % optional, remove the line if not wanted
...
\definecolor{color1}{rgb}{0,0,0.545098}%
...
\fcolorbox{color1}{white}{\includegraphics[width=64pt]{personal_photo.jpg}}
}%
\end{minipage}
\begin{minipage}{0.68\textwidth}
{\Large \textbf{\GONCVfirstname \\ \GONCVfamilyname}} \vspace{5pt} \\
\textcolor{gray}
{
  \GONCVaddress \\
 \mobilesymbol +34 628436393 \\
 \emailsymbol \href{mailto:gonzalo@grcanosa.com}{gonzalo@grcanosa.com}  \\
\GONCVextrainfo
 }
