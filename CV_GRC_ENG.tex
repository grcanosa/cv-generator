...
\title{PhD in Robotics}               % optional, remove the line if not wanted
\extrainfo{\linkedinsocialsymbol \href{https://www.linkedin.com/in/grcanosa}{grcanosa} \githubsocialsymbol \href{https://github.com/grcanosa}{grcanosa} \\Date of birth: 07-Dec-1984; DNI: 30229200R.} 
...
\quote{Doctor Engineer, 6 years of experience in hw+sw projects.\\ Great coding skills.}   
...
\subsection{Working}
\cventry{Feb 2014 \\present}{Senior development engineer}{eProsima}{Madrid}{Spain}{Real Time Publisher Subscriber (RTPS) implementation (DDS standard by the OMG) focused on performance and security.}
\cventry{Feb 2009 \\Nov 2013}{PhD researcher}{Robotic and Cybernetic Group}{Madrid}{Spain}{MultiRobot Systems for security and surveillance in Critical Infrastructures.}
\cventry{Sep 2011 \\Dec 2011}{Visiting researcher}{Robotics Research Group (UoA)}{Auckland}{New Zealand}{Dynamic object detection system from UAV based on optical flows differences, supervised by Dr. Bruce MacDonald}
\cventry{May 2008 \\Aug 2008}{Trainee Engineer}{Flight Science Dept. at Bombardier}{Montreal}{Canada}{User interface to optimize the documentation process of the simulation and testing reports.}
              % arguments 3 to 6 are optional
\subsection{Scholarships and Grants}
\cventry{Feb 2008 \\Apr 2008}{Research scholarship}{Transportation Engineer Dept.}{University of Seville}{Spain}{Study of the CANBUS devices, protocols and data in different automobiles.}
\cventry{Nov 2007 \\Jan 2008}{Final Degree Project}{Automatic and Systems Engineering Dept.}{Seville}{Spain}{User interface to define transportation and storage problems was created, along with a centralized control system to obtain the optimum solution.}

\section{Education}
\cventry{2009-2013}{PhD in Robotics and Automatics}{4 years}{Technical University of Madrid}{Spain}{}
\cventry{2008-2010}{MSc in Automatics and Robotics}{2 years}{Technical University of Madrid}{Spain}{}
\cventry{2006-2007}{Erasmus}{1 year}{Royal Institute of Technology (KTH), Stockholm}{Sweden}{}
\cventry{2002-2008}{MsC in Systems and Automatics Engineering \newline BSc in Industrial Engineering}{5 years}{University of Seville}{Spain}{}
\cventry{2000-2002}{Secondary Education in High-School Martinez Montañés}{Seville}{Spain}{}{International Baccalaureate Organization Diploma - IBO.}
\cventry{1988-2000}{Primary Education in German School Albrecht Dürer}{Seville}{Spain}{}{}



\section{Languages}
\cvlanguage{Spanish}{Native language}{}
\cvlanguage{English}{Full proffesional competence}{High written and spoken level.}
\cvlanguage{German}{Basic proffesional competence}{`Zentrale MittelstuffePrüfung` of the Goethe Institut (C1).}
...
\cvline{Programming}{User level of C\#, Python, Django, HTML, Java, Android SDK, OpenGL.}
\cvline{Development}{CMake, Makefile, Git, SVN, Eclipse, Microsoft Visual Studio 2010, GDB debugger, Valgrind.}

\subsection{Engineering Processes}
\cvline{Simulation}{Webots, Player-Gazebo, Simulink.}
