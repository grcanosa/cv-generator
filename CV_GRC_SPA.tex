...
\extrainfo{\linkedinsocialsymbol \href{https://www.linkedin.com/in/grcanosa}{grcanosa} \githubsocialsymbol \href{https://github.com/grcanosa}{grcanosa} \\Nacimiento: 07-Dic-1984; DNI: 30229200R.} 
...
\quote{Doctor Ingeniero, 6 años de experiencia en proyectos hw+sw. \\ Experto en programación orientada a objetos.}   
...
\section{Formación}
\cventry{2009-2013}{Doctorado en Robótica y Automática}{4 años}{Universidad Politécnica de Madrid}{}{}
\cventry{2008-2010}{Máster en Automática y Robótica}{2 años}{Universidad Politécnica de Madrid}{}{}
\cventry{2006-2007}{Erasmus}{1 año}{Royal Institute of Technology (KTH), Estocolmo}{Suecia}{}
\cventry{2002-2008}{Ingeniero Industrial, especialidad Automática}{5 años}{Universidad de Sevilla}{}{}
\cventry{2000-2002}{Bachillerato en I.E.S Martinez Montañés}{Sevilla}{}{}{Diploma de la Organización de Bachillerato Internacional - IBO.}
\cventry{1988-2000}{Educación primaria en el Colegio Alemán Alberto Durero}{Sevilla}{}{}{}
...
\cvlanguage{Alemán}{Competencia profesional básica.}{Nivel medio hablado y escrito.`Zentrale MittelstuffePrüfung` del Instituto Goethe (C1).}
...
\subsection{Informática / desarrollo}
\cvline{SO}{Linux and Windows.}
\cvline{Office}{MS Word, Excel, PowerPoint, LaTeX.}
\cvline{C++}{Gran experiencia en diversos proyectos con diferentes librerías (Boost, OpenCV, ...). Experiencia con técnicas de mejora de rendimiento y herramientas de profiler.}
\cvline{Programación}{Nivel básico de C\#, Python, Django, HTML, Java, Android SDK, OpenGL.}
\cvline{Desarrollo}{CMake, Makefile, Git, SVN, Eclipse, Microsoft Visual Studio 2010, GDB debugger, Valgrind.}

\subsection{Ingeniería}
\cvline{Simulación}{Webots, Player-Gazebo, Simulink.}
\cvline{Matlab}{Prototipado rápido de algoritmos. Generación de interfaces gráficas.}
\cvline{Robótica}{Robots aéreos y terrestres (UGV y UAV), Robot Operating System (ROS).}
\cvline{Visión}{Desarrollo experto en OpenCV y PCL(Point Cloud Library). Técnicas de calibrado, filtrado y segmentación de imágenes.}
\cvline{Hardware}{Experiencia en control de sensores y actuadores. Diseño de plataformas y mecanismos de adquisición de datos. Experiencia con sensores LIDAR y cámaras.}
